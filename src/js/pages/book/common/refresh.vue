<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        ...
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">与</text>
            <text ref="lTxt2" class="l-txt l-txt-2">书</text>
            <text ref="lTxt3" class="l-txt l-txt-3">与</text>
            <text ref="lTxt4" class="l-txt l-txt-4">世</text>
            <text ref="lTxt5" class="l-txt l-txt-5">界</text>
        </div>
    </refresh>
</template>
<script>
